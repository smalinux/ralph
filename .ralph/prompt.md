...
NEVER 'git add' or commit any file under issues/, docs/, or plans/ (they are read-only inputs); stage only code, tests, and progress.txt.
NEVER commit log or progress meta-data ralph related.
